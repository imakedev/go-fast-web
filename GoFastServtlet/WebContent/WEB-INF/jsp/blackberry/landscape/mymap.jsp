...
<tr valign="top">
<td align="center"> <img  
	src="http://maps.google.com/maps/api/staticmap?center=<%=request.getParameter("lat")%>,<%=request.getParameter("long")%>&markers=color:blue|label:Me|<%=request.getParameter("lat")%>,<%=request.getParameter("long")%>&zoom=12&size=460x200&sensor=false"></img>
</td>
</tr>
</table>
